...
<div class="right">
  ...
  <br />
  <div style="display: <?php echo (count($customer_groups) > 1 ? 'table-row' : 'none'); ?>;"> <label class="checkout-label"><?php if (isset($entry_customer_group)) echo $entry_customer_group; ?></label>

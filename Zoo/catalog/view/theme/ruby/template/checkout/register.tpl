...
<div class="right">
  ...
  <label class="checkout-label"><?php if (isset($entry_customer_group)) echo $entry_customer_group; ?></label>
...
$('#payment-address select[name=\'country_id\']').bind('change', function() {
	$.ajax({
		...
		dataType: 'json',
		beforeSend: function() {
			$('#payment-address select[name=\'country_id\']').after('<span class="wait">&nbsp;<img src="catalog/view/theme/ruby/image/loading.gif" alt="" /></span>');
		},
		complete: function() {
			$('.wait').remove();
		},			

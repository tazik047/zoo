<div class="box banner boxnews">
  <div class="bannerHeader newh"> <h3><?php echo $heading_title; ?></h3>
 <p class="newsPara"> Lorem ipsum dolor sit amen, 
dolor imun ra adlip ulissys </p>
  
  </div>
  <div class="box-content newscontent" style="text-align: center;">
